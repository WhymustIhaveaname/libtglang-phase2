...
keywords.update({'                    ', '--------------------', '00000000000000000000', '####################', '====================', '////////////////////', '\xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 ', ' \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0', 'Players.LocalPlayer.', 'using namespace std;', 'layer.Character.HumanoidRootPart.CFrame', '"@openzeppelin/contracts/', 'githubusercontent.com', 'PhpAmqpLib\\\\Message\\\\AMQPMessage',
                 'System.out.println(', 'trigger.action.outText(', '"type": "supergroup"',
                 'await raider.send_message(',
                 'background-color:'
                 '                ', '----------------', '0000000000000000', '################', '\xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 \xa0 ', '================',
                 '#include <iostream>', 'using namespace', 'getElementById(',
                 '            ', '------------', '000000000000', '\xa0 \xa0 \xa0 \xa0 \xa0 \xa0 ',
                 'new HByte()',
                 'console.log(', 'Console\\\\',
                 '        ', '--------', '00000000', '\xa0 \xa0 \xa0 \xa0 ', '########', 'function', '\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0', 'https://', '========', 'username', 'contract', 'position', '#define ', 'message_', 'println(',
                 'console', 'install', '2023-10', 'Command', 'println', 'command', 'location =', 'Session', 'include', 'count <<'
                 'return', 'import', 'print(', 'string', 'String', 'public', 'handle', 'create', 'type":', 'Button', 'header', 'contex', 'struct', 'width:', 'System', 'config', '.print', 'main()', 'CFrame', 'cout<<', 'filter',
                 'print', 'const', 'class', '_name', 'count', 'quest', 'index', 'input', 'value', 'https', 'width', 'layer', '.log(', 'range', 'send_',
                 '    ', '0000', 'name', '----', ') {\n', '\xa0 \xa0 ', 'int(', ': {\n', 'self', 'http', 'from', 'if (', '####', '() {', 'true', 'main', 'list', 'else', 'void', 'size', '====', ') =>', 'load', 'char',
                 '": ', ');\n', 'int', '000', '// ', '---', ') {', 'end', 'for', 'str', '",\n', '\xa0\xa0\xa0', '":"', 'new', 'def', ': {', '()\n', '() ', '):\n', '();', '===',
                 ';\n', ')\n', ',\n', '{\n', ');', '}\n', '()', '//', ':\n', '>\n', '\xa0\xa0', '))', '==', '<<', '} ', '},', ']\n', '->', '=>', '=<', '>>', '<=', '>=', '<-',
                 '(', ')', ':', '=', '_', '/', '-', ';', '{', '}', '>', '<', '[', ']', '#', '\xa0', '\\'})
keywords.update({"is_bot", 'Character.', '<iostream>', '<< endl;\n', 'for (int ', 'for(int ', 'main() {\n', 'main(){\n', 'printf("', 'function(', 'for i in ', '(int i = ',
                 'https://', ' cout <<', 'main() {', '} else {', ' else {\n', 'cout <<', ') => {\n', '#define', '"https:',
                 'print(', ') => {', '} else', 'break;', '() {\n', 'sudo ', 'int ', '=> {', '.log', '));\n',
                 '": ', ');\n', ': "', '// ', '---', ') {', '",\n', '":"', '","', '", ', '()\n', '();', '() ', '")\n', '},\n', '))\n', ': [',
                 ';\n', ')\n', ',\n', '{\n', ');', '",', '}\n', '()', '//'
